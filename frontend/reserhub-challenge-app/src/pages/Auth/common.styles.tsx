export const styles = {
    containerMain: "flex justify-center mt-20",
    containerBody: "bg-white p-10 rounded-xl shadow-lg w-full max-w-sm ",
    containerImage: "mx-auto w-20 h-20 rounded-full flex items-center justify-center mb-6",
    imageLogo: "h-auto max-w-full dark:shadow-gray-800",
    textTitle: "text-2xl font-semibold text-gray-900 mb-8 text-center",
